...
func (c *Client) noder(ctx context.Context, table string, id int) (Noder, error) {
	switch table {
	case unrenameduser.Table:
		query := c.UnrenamedUser.Query().
			Where(unrenameduser.ID(id))
		query, err := query.CollectFields(ctx, "UnrenamedUser")
		if err != nil {
			return nil, err
		}
